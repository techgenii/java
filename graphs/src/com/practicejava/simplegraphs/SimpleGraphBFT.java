...
public class SimpleGraphBFT // adds a method DFT to the class in Figure 9.14
{   
	...
	{ 
		int v;
		Queue<Integer> queue = new LinkedList<Integer>(); // uses Java Stack class
		...
		queue.add(firstVertex); // visit the first vertex
	...
	{  
		SimpleGraphBFT flyUS = new SimpleGraphBFT(5);
		...
		System.out.println("BFT of the graph in Figure 9.23 starting at Vertex 3, \"V3\"");
		flyUS.BFT(3);
	} // end main method
} // end class SimpleGraphBFT
